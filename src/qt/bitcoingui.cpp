    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("SpaceCoin") + " - " + tr("Wallet"));
    ...
    qApp->setStyleSheet(\
                      ...
                      \
                      #spacer2 { background:rgb(24,24,24);border:none; } \
                      #spacer { background:rgb(96,24,24);border:none; } \
                      #toolbar2 \
                      { \
                           border:none; \
                           width:0px; \
...
#endif
                     " #OverviewButton:hover {background-color: rgb(181,181,181); border: none;} \
                       #OverviewButton:checked {background-color: rgb(120,120,120); border: none;} \
                       #SendButton:hover {background-color: rgb(181,181,181); border: none;} \
                       #SendButton:checked {background-color: rgb(120,120,120); border: none;} \
                       #ReceiveButton:hover {background-color: rgb(181,181,181); border: none;} \
                       #ReceiveButton:checked {background-color: rgb(120,120,120); border: none;} \
                       #HistoryButton:hover {background-color: rgb(181,181,181); border: none;} \
                       #HistoryButton:checked {background-color: rgb(120,120,120); border: none;} \
                       #AddressBookButton:hover {background-color: rgb(181,181,181); border: none;} \
                       #AddressBookButton:checked {background-color: rgb(120,120,120); border: none;} \
                       #MessageButton:hover {background-color: rgb(181,181,181); border: none;} \
                       #MessageButton:checked {background-color: rgb(120,120,120); border: none;} \
                     #labelMiningIcon \
                      { \
                           padding-left:5px; \
                      ...
                      \
                      QMenu { background: rgb(24,24,24); color:white; padding-bottom:10px; } \
                      QMenu::item { color:white; background-color: transparent; } \
                      QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(181,181,181), stop: 1 rgb(181,181,181));} \
                      QMenuBar { background: rgb(24,24,24); color:white; } \
                      QMenuBar::item \
                      { \
                            font-size:12px; \
                            padding-bottom:8px; \
                      ...
                      \
                      QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(181,181,181), stop: 1 rgb(181,181,181));} \
                      ");
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SpaceCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SpaceCoin"), this);
    aboutAction->setToolTip(tr("Show information about SpaceCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SpaceCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SpaceCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SpaceCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SpaceCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SpaceCoin address or malformed URI parameters."));
    }
