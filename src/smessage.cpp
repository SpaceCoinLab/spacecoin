// Copyright (c) 2014 The SpaceCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("spacecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("spacecoin-smsg-pow"); // Make this thread recognisable
